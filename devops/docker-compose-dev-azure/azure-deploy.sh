...
resourcename="clothesdesignerbranddistribution"  # lower case, only
resourcegroup="clothesdesignerbranddistribution_rg"
...
# git clone https://github.com/apilogicserver/clothesdesignerbranddistribution.git
# cd clothesdesignerbranddistribution
...
az group create --name clothesdesignerbranddistribution_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group clothesdesignerbranddistribution_rg --sku S1 --is-linux
az container create --resource-group clothesdesignerbranddistribution_rg --name clothesdesignerbranddistribution --image apilogicserver/clothesdesignerbranddistribution:latest --dns-name-label clothesdesignerbranddistribution --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//clothesdesignerbranddistribution.westus.azurecontainer.io:5656'
