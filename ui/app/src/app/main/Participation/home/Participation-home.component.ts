...
@Component({
  selector: 'Participation-home',
  templateUrl: './Participation-home.component.html',
  styleUrls: ['./Participation-home.component.scss']
})
export class ParticipationHomeComponent implements AfterViewInit {
